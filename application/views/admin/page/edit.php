...
<h3><?php echo empty($page->id) ? 'Add a new page' : 'Edit page ' . $page->title; ?></h3>
	...
	<table class="table">
		...
		<tr>
			<td>Template</td>
			<td><?php echo form_dropdown('template', array('page' => 'Page', 'news_archive' => 'News archive', 'home' => 'Home'), $this->input->post('template') ? $this->input->post('template') : $page->template); ?></td>
		</tr>
		<tr>
			<td>Title</td>
